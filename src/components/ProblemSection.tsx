...
export default function ProblemSection() {
  return (
    <section id="capabilities" className="relative scroll-mt-12 lg:scroll-mt-20">
      <div className="w-full">
        {/* Main Content */}
        <div className="bg-[#f4f3ec] max-w-7xl mx-auto px-6 md:px-12 lg:pl-16 lg:pr-24 py-16 md:py-20 pt-[80px] pr-[96px] pb-[80px] pl-[65px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-12">
            {/* Card 1 - ChatGPT */}
            <div className="bg-[#eeede6] border border-[#bebeb8] relative">
              {/* Header Tag */}
              ...
              {/* Card Content */}
              <div className="p-4">
                <div className="bg-white rounded-lg h-[250px] md:h-[300px] lg:h-[320px] w-full"></div>
              </div>
            </div>
          ...
          {/* Pain Points Text Below Cards */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-20">
            <div>
              <p className="font-['Sora',sans-serif] text-[18px] text-[#676767] leading-relaxed">
                ChatGPT sounds <span className="bg-[#fff3be]">generic</span> and kills <span className="bg-[#fff3be]">credibility</span>
              </p>
            </div>
            <div>
              <p className="font-['Sora',sans-serif] text-[18px] text-[#676767] leading-relaxed">
                Ghostwriter <span className="bg-[#fff3be]">never understand</span> your business
              </p>
            </div>
            <div>
              <p className="font-['Sora',sans-serif] text-[18px] text-[#676767] leading-relaxed">
                Agency gives your <span className="bg-[#fff3be]">generic posts</span>, you're still the bottleneck
              </p>
            </div>
          </div>
